...
//   return (
//     <div>
//       <nav className="fixed top-0 left-0 w-full h-17  flex justify-between items-center gap-2 bg-white px-3">
//         {/* search box */}
...
//         </Link>
//       </nav>
//       <nav className="w-full h-20 fixed bottom-0 right-0 bg-amber-200">
//         <h2>MobileNavbar</h2>
//       </nav>
//     </div>
//   );
...
// // prop onOpenSearch را دریافت می‌کند
...
//           onClick={onOpenSearch} // اینجا prop را فراخوانی کنید
//         >
//           <div>
//             <input
//               type="text"
//               readOnly
//               placeholder="جستجو در دیجیتال لند"
//               className="w-full bg-[#f0f0f1] h-11 rounded-full pr-10 pl-4 placeholder:text-[15px] outline-0 focus:ring-1 focus:ring-gray-300 transition-all font-samim pointer-events-none"
//             />
//           </div>
//           <div className="absolute top-1/2 -translate-y-1/2 px-4">
//             <BiSearch className="text-xl text-gray-500" />
